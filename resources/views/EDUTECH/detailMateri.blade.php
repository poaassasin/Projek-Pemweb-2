    ...
    <section class="container mx-auto lg:px-20 px-4 py-10">
        ...
        <form action="">
            <div class="relative  border-4 p-8 rouned border-[#A855F7]">
                <label for="file-upload" class="  w-full border-4 h-96 flex flex-col justify-center items-center rounded border-[#A855F7] text-base text-center lg:text-2xl text-gray-500 font-bold border-dashed cursor-pointer">
                    <img draggable="false" src="{{ asset('assets/upload.png') }}" class="lg:w-1/5 w-2/5" alt="logo">
