...
<body class="font-[Poppins]">
    <div class="h-screen w-full flex">
        <div class="lg:w-1/2 w-1/4 bg-image bg-[#C084FC]  h-full flex flex-col justify-center items-center">
            <img draggable="false" src="{{ asset('assets/authImage.png') }}" class="w-3/5 aspect-auto" alt="">
            <img draggable="false" src="{{ asset('assets/logo.png') }}" class="w-2/5 aspect-auto" alt="">
