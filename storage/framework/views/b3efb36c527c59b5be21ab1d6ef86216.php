...
<body class="font-[Poppins]">
    ...
    <section class="bg-image bg-[#C084FC] lg:h-[75vh] ">
        <main class="container mx-auto flex lg:flex-row relative py-5  flex-col-reverse items-center h-full lg:px-20 px-4">
            ...
            <img draggable="false" src="<?php echo e(asset('assets/dashboardImg.png')); ?>" class="lg:w-3/6 lg:absolute bottom-0 lg:translate-y-1/4 right-0 aspect-auto" alt="">
        </main>
    </section>
...
<?php /**PATH E:\FREELANCE JOKI\Joki Azke\Projek-Pemweb-2\resources\views/EDUTECH/dashboard.blade.php ENDPATH**/ ?>